...
class FCNMulLabelHead(FCNHead):
    ...
    def __init__(self,
        ...
        self.wei_expert_pool = nn.AvgPool2d(kernel_size=pool_kernel)
    ...
    def forward_train(self,
        ...
        Args:
            ...
            img (Tensor): Input image to compute weight for each expert.
        ...
        losses = self.losses(seg_logits, gt_semantic_seg, weight_map, img)
        return losses

    @force_fp32(apply_to=('seg_logit', ))
    def losses(self, seg_logit, seg_label, mul_label_weight, img):
        ...
        loss_mul_label = torch.stack(loss_mul_labels).permute(1, 0, 2, 3)
        loss_mul_label = (loss_mul_label * mul_label_weight).mean()
